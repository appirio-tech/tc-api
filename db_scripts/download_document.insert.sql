...
INSERT INTO payment_terms (payment_terms_id, description, creation_date, creation_user, modification_date, modification_user, active, term) 
VALUES (6000000, 'Payment Terms 1', CURRENT, 132456, CURRENT, 132456, 1, 1);

INSERT INTO company (company_id, name, passcode, is_deleted, creation_date, creation_user, modification_date, modification_user) 
VALUES (6000003, 'c', 'PASSCODE 1(6000003)', 0, CURRENT, 132456, CURRENT, 132456);

INSERT INTO client (client_id, name, company_id, payment_term_id, status, salestax, start_date, end_date, code_name, is_deleted, client_status_id, creation_date, creation_user, modification_date, modification_user) 
