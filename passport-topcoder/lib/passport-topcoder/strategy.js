...
function Strategy(options, verify) {
    options = options || {};
    options.tokenURL = options.tokenURL || 'http://api.cloud.topcoder.com/oauth/oauth/token';
    options.authorizationURL = options.authorizationURL || 'http://api.cloud.topcoder.com/oauth/tc/authorize';
