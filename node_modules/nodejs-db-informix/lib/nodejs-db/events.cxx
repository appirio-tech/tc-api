...
v8::Persistent<v8::String> nodejs_db::EventEmitter::syEmit;
#endif

nodejs_db::EventEmitter::EventEmitter() : node::ObjectWrap() {
}

void nodejs_db::EventEmitter::Init() {
#if !NODE_VERSION_AT_LEAST(0, 5, 0)
    syEmit = NODE_PERSISTENT_SYMBOL("emit");
#endif
}

bool nodejs_db::EventEmitter::Emit(const char* event, int argc, v8::Handle<v8::Value> argv[]) {
