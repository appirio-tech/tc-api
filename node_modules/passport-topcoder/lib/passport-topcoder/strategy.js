...
function Strategy(options, verify) {
    options = options || {};
    options.tokenURL = options.tokenURL || 'http://107.21.158.122/oauth/oauth/token';
    options.authorizationURL = options.authorizationURL || 'http://107.21.158.122/oauth/tc/authorize';
