...
var SQL_DIR = __dirname + "/sqls/studioReviewOpportunityDetails/";
...
describe('Get Studio Review Opportunity Details API', function () {
    ...
    var errorMessage = fs.readFileSync('test/test_files/expected_get_studio_review_opportunity_details_error_message.txt', 'utf8'),
    ...
    it('should return Not Found Error. the challenge didn\'t exist', function (done) {
        request(API_ENDPOINT)
            ...
            .end(function (err, result) {
                if (!err) {
                    assert(result.body.error.details.trim(), "The studio challenge is not found.", 'Invalid error message');
                } else {
                    return done(err);
                }
                done();
    ...
    it('should return Bad Request. challenge id is not number', function (done) {
        request(API_ENDPOINT)
    ...
    it('should return Bad Request. challenge id is 0', function (done) {
        request(API_ENDPOINT)
    ...
    it('should return Bad Request. challenge id is negative', function (done) {
        request(API_ENDPOINT)
    ...
    it('should return Bad Request. challenge id is too big', function (done) {
        request(API_ENDPOINT)
