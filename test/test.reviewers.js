...
describe('Get Reviewers API', function () {
    ...
    function createRequest(statusCode, authHeader) {
        var url = "/v2/admin/reviewers?categoryId=7",
    ...
    it("should return reviewers", function (done) {
        assertResponse(adminHeader, "expect_get_reviewers", done);
    });
