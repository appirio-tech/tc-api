...
var SQL_DIR = "sqls/topsSRM/";
var API_ENDPOINT = process.env.API_ENDPOINT || 'http://localhost:8080';

describe('Get Top Ranked SRM Members API', function () {
    ...
    function clearDb(done) {
        testHelper.runSqlFromJSON(SQL_DIR + "topcoder_dw__clean.json", done);
    }
    ...
    before(function (done) {
        async.waterfall([
            clearDb,
            function (cb) {
                testHelper.runSqlFromJSON(SQL_DIR + "topcoder_dw__insert_test_data.json", cb);
            }
        ], done);
    });
    ...
    function assertResponse(queryString, file, done) {
        request(API_ENDPOINT)
            .get('/v2/data/srm/statistics/tops?' + queryString)
    ...
    /**
     * /v2/data/srm/statistics/tops?rankType=competitors
     */
    it('should return valid result for ?rankType=competitors (file #1)', function (done) {
        assertResponse("rankType=competitors", "expected_top_srm_1", done);
    });


    /**
     * /v2/data/srm/statistics/tops?rankType=schools
     */
    it('should return valid result for ?rankType=schools (file #2)', function (done) {
        assertResponse("rankType=schools", "expected_top_srm_2", done);
    });


    /**
     * /v2/data/srm/statistics/tops?rankType=countries
     */
    it('should return valid result for ?rankType=countries (file #3)', function (done) {
        assertResponse("rankType=countries", "expected_top_srm_3", done);

    });

    /**
     * /v2/data/srm/statistics/tops?rankType=competitors&pageSize=2&pageIndex=3
     */
    it('should return valid result for ?rankType=competitors&pageSize=2&pageIndex=3 (file #4)', function (done) {
        assertResponse("rankType=competitors&pageSize=2&pageIndex=3", "expected_top_srm_4", done);
    });


    /**
     * /v2/data/srm/statistics/tops?rankType=schools&pageSize=2&pageIndex=3
     */
    it('should return valid result for ?rankType=schools&pageSize=2&pageIndex=3 (file #5)', function (done) {
        assertResponse("rankType=schools&pageSize=2&pageIndex=3", "expected_top_srm_5", done);
    });


    /**
     * /v2/data/srm/statistics/tops?rankType=countries&pageSize=2&pageIndex=3
     */
    it('should return valid result for ?rankType=countries&pageSize=2&pageIndex=3 (file #6)', function (done) {
        assertResponse("rankType=countries&pageSize=2&pageIndex=3", "expected_top_srm_6", done);
    });

    /**
     * /v2/data/srm/statistics/tops?rankType=competitors&pageIndex=-1
     */
    ...
    /**
     * /v2/data/srm/statistics/tops?rankType=competitors&pageSize=xyz
     */
    ...
    /**
     * /v2/data/srm/statistics/tops?rankType=competitors&pageSize=0
     */
    ...
    /**
     * /v2/data/srm/statistics/tops?rankType=competitors&pageSize=-1
     */
    ...
    /**
     * /v2/data/srm/statistics/tops?rankType=competitors&pageSize=100000000000000000000
     */
    ...
    /**
     * /v2/data/srm/statistics/tops?rankType=competitors&pageSize=1.123
     */
    ...
    /**
     * /v2/data/srm/statistics/tops?rankType=competitors&pageIndex=xyz
     */
    ...
    /**
     * /v2/data/srm/statistics/tops?rankType=competitors&pageIndex=0
     */
    ...
    /**
     * /v2/data/srm/statistics/tops?rankType=competitors&pageIndex=-2
     */
    ...
    /**
     * /v2/data/srm/statistics/tops?rankType=competitors&pageIndex=100000000000000000000
     */
    ...
    /**
     * /v2/data/srm/statistics/tops?rankType=competitors&pageIndex=1.123
     */
